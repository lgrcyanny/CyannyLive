...
// 	Functions for adding script
	...
	wp_enqueue_style('d5businessline-gfonts1', 'http://fonts.googleapis.com/css?family=Oswald', false );
	wp_enqueue_style('d5businessline-gfonts2', 'http://fonts.googleapis.com/css?family=Droid+Sans', false );
